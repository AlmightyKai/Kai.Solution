...
{
    public class EfCoreLinkUserRepository : EfCoreRepository<IDbContext, IdentityLinkUser, Guid>, IIdentityLinkUserRepository
    {
        public EfCoreLinkUserRepository(IDbContextProvider<IDbContext> dbContextProvider)
