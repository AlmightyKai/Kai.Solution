...
{
    public class EfCoreUserRepository : EfCoreRepository<IDbContext, IdentityUser, Guid>, IIdentityUserRepository
    {
        public EfCoreUserRepository(IDbContextProvider<IDbContext> dbContextProvider)
