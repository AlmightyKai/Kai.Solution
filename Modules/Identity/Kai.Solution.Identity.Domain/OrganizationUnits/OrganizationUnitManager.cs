...
namespace Kai.Solution.Identity
{
    ...
    public class OrganizationUnitManager : DomainService
    {
        ...
        protected virtual async Task ValidateOrganizationUnitAsync(OrganizationUnit organizationUnit)
        {
            ...
            {
                throw new BusinessException(ErrorCodes.DuplicateOrganizationUnitDisplayName)
        ...
        public virtual Task AddRoleToOrganizationUnitAsync(Role role, OrganizationUnit ou)
        {
        ...
        public virtual Task RemoveRoleFromOrganizationUnitAsync(Role role, OrganizationUnit organizationUnit)
        {
