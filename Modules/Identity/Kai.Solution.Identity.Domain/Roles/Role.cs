...
namespace Kai.Solution.Identity
{
    ...
    public class Role : AggregateRoot<Guid>, IMultiTenant
    {
        ...
        public Role(Guid id, [NotNull] string name, Guid? tenantId = null)
        {
        ...
        public virtual void AddClaim([NotNull] IGuidGenerator guidGenerator, [NotNull] Claim claim)
        {
            ...
            Claims.Add(new RoleClaim(guidGenerator.Create(), Id, claim, TenantId));
        }
        ...
        public virtual RoleClaim FindClaim([NotNull] Claim claim)
        {
            Check.NotNull(claim, nameof(claim));
