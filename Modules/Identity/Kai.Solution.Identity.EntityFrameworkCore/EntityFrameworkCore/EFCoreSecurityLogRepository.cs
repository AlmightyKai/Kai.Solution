...
{
    public class EFCoreSecurityLogRepository : EfCoreRepository<IDbContext, SecurityLog, Guid>, IIdentitySecurityLogRepository
    {
        public EFCoreSecurityLogRepository(IDbContextProvider<IDbContext> dbContextProvider)
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            return await query.OrderBy(sorting.IsNullOrWhiteSpace() ? $"{nameof(SecurityLog.CreationTime)} desc" : sorting)
        ...
        public virtual async Task<SecurityLog> GetByUserIdAsync(Guid id, Guid userId, bool includeDetails = false, CancellationToken cancellationToken = default)
        {
        ...
        protected virtual async Task<IQueryable<SecurityLog>> GetListQueryAsync(
              DateTime? startTime = null,
              DateTime? endTime = null,
              string applicationName = null,
              string identity = null,
