...
{
    public class EfCoreClaimTypeRepository : EfCoreRepository<IDbContext, IdentityClaimType, Guid>, IIdentityClaimTypeRepository
    {
        public EfCoreClaimTypeRepository(IDbContextProvider<IDbContext> dbContextProvider)
