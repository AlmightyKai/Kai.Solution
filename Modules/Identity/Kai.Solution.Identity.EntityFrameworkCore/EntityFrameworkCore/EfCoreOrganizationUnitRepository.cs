...
{
    public class EfCoreOrganizationUnitRepository : EfCoreRepository<IDbContext, OrganizationUnit, Guid>, IOrganizationUnitRepository
    {
        public EfCoreOrganizationUnitRepository(IDbContextProvider<IDbContext> dbContextProvider)
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            query = query
                .OrderBy(sorting.IsNullOrEmpty() ? nameof(Role.Name) : sorting)
                .PageBy(skipCount, maxResultCount);
        ...
        public virtual async Task<List<Role>> GetUnaddedRolesAsync(
            OrganizationUnit organizationUnit,
            string sorting = null,
            int maxResultCount = int.MaxValue,
            int skipCount = 0,
